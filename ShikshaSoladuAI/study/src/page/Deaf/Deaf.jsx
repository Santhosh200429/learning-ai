  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 ml-64 mt-14">
          {/* Welcome Section */}
          <h1 className="text-4xl font-bold text-blue-600 mb-6">
          Welcome back, <span className="text-indigo-700">Aditya</span>!
          </h1>

      {/* Stylish Time and Date Display */}
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 rounded-lg shadow-lg mb-6">
        <div className="text-white text-5xl font-bold mb-2">{formattedTime}</div>
        <div className="text-white text-xl font-medium">{formattedDate}</div>
      </div>
